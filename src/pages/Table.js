  ...
  const handleAML = () => {
    ...
    return (
      <div className="flex-grow mt-2 mx-4 gap-5   ">
        <div className="bg-white  gap-y-7 flex  shadow-md shadow-slate-300  h-20 border border-black ">
        ...
        {active === "details" &&  
          <div className="bg-white flex-col flex shadow-md shadow-slate-300 pt-3 pl-3  px-2 h-[460px] border border-black ">
        ...
        <div className="flex flex-col  ">
          ...
          <div className="bg-white flex-col flex  w-[50%]  shadow-md shadow-slate-300 pt-3 pl-3  px-2 h-[230px] border border-black ">
            <div className="flex flex-row justify-between">
            ...
            <div className="bg-white flex-col flex  w-[50%] ml-3 shadow-md shadow-slate-300 pt-3 pl-3  px-2 h-[230px] border border-black ">
            <div className="flex flex-row justify-between">
                <p>Source Of Fund</p>
                <div className="flex flex-row items-center gap-1  ">
              <button className=" flex flex-row px-2 items-center gap-1 p-1 text-white text-sm bg-black rounded-sm">
