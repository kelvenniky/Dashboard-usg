    ...
    <div className="flex-grow mb-2 mx-2  ">
      <div className="my-1">
        <select
          ...
          className="bg-gray-200 py-1 px-1 outline-none  mb-1 border-black shadow shadow-slate-200"
        >
          <option value="biodata">ℹ️
          Biodata</option>
          <option value="work">ℹ️Work Data</option>
        </select>
        {sortOption === "biodata" ? (
          <div className="bg-white items-center mb-2 flex flex-grow justify-between shadow-sm shadow-slate-300 px-2 py-3 border border-black">
